...
/**
 * Configuration for replicating the content stores on a remote Indy system
 *
 */
        ...
        implements Iterable<ReplicationAction>
{
    ...
    {
        return String.format( "ReplicationDTO [overwrite=%s, apiUrl=%s, proxyHost=%s, proxyPort=%s, actions=%s]",
                              overwrite, apiUrl, proxyHost, proxyPort, actions );
    }
