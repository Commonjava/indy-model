        ...
        implements Comparable<IndyAddOnID>
{
    ...
    //List of router entries (mainly for use in the UI)
    private List<UIRoute> routes;

    // List of menu sections (mainly for use in the UI)
    private List<UISection> sections;

    // Path to the Javascript needed to drive the UI for this add-on
